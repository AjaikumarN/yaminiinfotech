  ...
  const sections = [
    {
      title: 'Main',
      items: [
        { icon: '🏠', label: 'Dashboard', path: '/salesman/dashboard' },
        { icon: '🕘', label: 'Attendance', path: '/salesman/attendance' }
      ]
    },
    {
      title: 'Sales Activities',
      items: [
        { icon: '📋', label: 'Enquiries & Leads', path: '/salesman/enquiries' },
        { icon: '📞', label: 'Calls', path: '/salesman/calls' },
        { icon: '🔁', label: 'Follow-Ups', path: '/salesman/followups' },
        { icon: '🧾', label: 'Orders', path: '/salesman/orders' }
      ]
    },
    {
      title: 'Reports & Compliance',
      items: [
        { icon: '📝', label: 'Daily Report', path: '/salesman/daily-report' },
        { icon: '⚖️', label: 'Discipline & Compliance', path: '/salesman/compliance' }
      ]
    }
  ];
