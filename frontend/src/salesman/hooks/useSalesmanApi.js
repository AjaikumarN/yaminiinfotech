...
//========== CALLS ==========
export const getMyCalls = async (today = false) => {
  return apiRequest(`/api/sales/my-calls${today ? '?today_only=true' : ''}`);
};
...
export const getDashboardStats = async () => {
  try {
    ...
    const allCalls = await getMyCalls(false); // Get all calls
