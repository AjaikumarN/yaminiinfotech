...
export default function DashboardLayout({ role }) {
  ...
  const renderTopBar = () => {
    // Only Admin has custom topbar currently
    if (currentRole === 'ADMIN') {
      return (
        <div className="able-topbar">
          <AdminTopBar onMenuToggle={() => {
            if (isMobile) {
    ...
    // Other roles can share common topbar or none
    // For now, let their individual layouts handle it
    return null;
  };
