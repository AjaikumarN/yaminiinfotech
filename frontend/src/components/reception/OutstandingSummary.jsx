      ...
      {showCreateModal && (
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={(e) => {
              e.preventDefault();
              // Add to outstanding data manually
              const newRecord = {
                id: Date.now(),
                ...
                balance: parseFloat(formData.total_amount) - parseFloat(formData.paid_amount),
                due_date: new Date(formData.due_date),
                days_overdue: Math.max(0, Math.floor((new Date() - new Date(formData.due_date)) / (1000 * 60 * 60 * 24))),
                order_date: new Date()
              };
              setOutstandingData([...outstandingData, newRecord]);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={(e) => {
              ...
              const updated = outstandingData.map(item => 
