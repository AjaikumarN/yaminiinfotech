                ...
                <div className="job-card-body">
                  ...
                  <div className="job-details">
                    <div className="detail-item">
                      ...
                      <span>{service.customer_company || 'N/A'}</span>
                    </div>
                    <div className="detail-item">
                      <span className="detail-icon">📞</span>
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  ...
                  <div><strong>Company:</strong> {detailModal.service.customer_company || 'N/A'}</div>
                  <div><strong>Phone:</strong> {detailModal.service.customer_phone}</div>
                  <div><strong>Email:</strong> {detailModal.service.customer_email || 'N/A'}</div>
                </div>
              </div>
