...
const ServiceEngineerNav = ({ isOpen, onClose }) => {
  ...
  const sections = [
    {
      title: 'Main',
      items: [
        { icon: '🏠', label: 'Dashboard', path: '/service-engineer/dashboard' },
        { icon: '🕘', label: 'Daily Start', path: '/service-engineer/attendance' }
      ]
    },
    {
      title: 'Work Management',
      items: [
        { icon: '🛠', label: 'Assigned Jobs', path: '/service-engineer/jobs' },
        { icon: '🔁', label: 'Service History', path: '/service-engineer/history' },
        { icon: '⏱', label: 'SLA Tracker', path: '/service-engineer/sla-tracker' }
      ]
    },
    {
      title: 'Reports & Feedback',
      items: [
        { icon: '⭐', label: 'Customer Feedback', path: '/service-engineer/feedback' },
        { icon: '📊', label: 'Daily Update', path: '/service-engineer/daily-report' }
      ]
    }
  ];
  ...
  const getLinkStyles = (isActive) => ({
    ...
    cursor: 'pointer',
    border: '1px solid',
    borderColor: isActive ? 'rgba(102, 126, 234, 0.2)' : 'transparent',
    width: '100%',
    textAlign: 'left'
  });
        ...
        <div style={headerStyles}>
          <div style={logoStyles}>
            ...
            <div style={logoTextStyles}>
              <h2 style={logoTitleStyles}>Service Engineer</h2>
              <p style={logoSubtitleStyles}>Field Operations</p>
            </div>
            <button
              onClick={onClose}
